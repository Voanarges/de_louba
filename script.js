...
/* harmony import */ var _modules_description__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/description */ "./src/js/modules/description.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_description__WEBPACK_IMPORTED_MODULE_1__["default"])('.myworks__fon', '.myworks__description');
});
...
var description = function description(fon, elem) {
  var fons = document.querySelectorAll(fon),
...
var forms = function forms() {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      postData('./mailer/smart.php', formData).then(function (result) {
